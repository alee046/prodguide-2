...
function getTreeCategories($parent_id, $is_child, $tabs=0) {
	...
	foreach ($categories as $category) {
		...
		$html .= str_repeat(" ", $tabs*3) . $li . '<a href="#" data-category_id="'.$category->getId().'">'.$category->getName();
		//$html .= " <span style='color:#999;'>(".$pcount.")</span>";
		$html .= "</a>";
		if($subcats != '') {
   ...
   <div class="container-fluid">
      ...
      <div class="" id="bs-example-navbar-collapse-1"><!-- removed class "collapse navbar-collapse" -->
         <ul class="nav navbar-nav navbar-right">
            ...
            <li>
               <a href="/prodguide/logout" style="">Log Out</a>
            </li>
            <li>  
               <form class="navbar-form navbar-right" role="search" onsubmit="return false;">
                  <div class="form-group">
                  	<input type="text" class="form-control" placeholder="Search" id="prod_name_search" style="width:200px;">
                  </div>
