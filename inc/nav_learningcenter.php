   ...
   <div class="container-fluid">
      ...
      <div class="" id="bs-example-navbar-collapse-1"><!-- removed class "collapse navbar-collapse" -->
         <ul class="nav navbar-nav navbar-right">
            <li><a href="/prodguide/learning-center">Learning Center</a></li>
            <li><a href="/prodguide/learning-center/quiz">Quiz</a></li>
            <li><a href="/prodguide">Product Guide</a></li>
            <li><a href="/prodguide/logout">Log Out</a></li>
         </ul>
      </div>
   </div>
</nav>