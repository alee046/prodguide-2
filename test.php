...
<style>
	...
	.learning_center .tab-pane .row { border: 1px solid #CCC; border-top:none; background-color:#F5FFFF; }
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-10">         
           ...
           <?php require("learning_center_test/chapter_1.html"); ?>
            <?php require("learning_center_test/chapter_3.html"); ?>
         </div>
        <div class="col-sm-2">
