<h2>Chapter 1: Introduction to Vaporization <span id="expand-all-01" class="expand-text expand-all">Expand</span></h2>

<ul class="chapter">


   <li>
      <div class="section_title"><span class="arrow" style="padding-right:20px;">&#x25BC;</span>What is Vaporization?</div>
      <div class="section_data" style="display:none;"><p>Vaporization is the process of heating plant material gradually below the point at which it burns, releasing the active compounds in the form of vapor, not smoke.</p></div>
   </li>
   <li>
      <div class="section_title"><span class="arrow" style="padding-right:20px;">&#x25BC;</span>What is a Vaporizer?</div>
      <div class="section_data" style="display:none;"><p>A vaporizer is a device used to release the active ingredients of plant material or to release the therapeutic compounds. A healthier alternative to smoking, vaporizers heat the material at a much lower temperature (when compared to smoking) so that the active compounds contained in the plant material produce an aromatic vapor (instead of smoke). Rather than burning the plant material, which can produce numerous harmful by-products, this vapor contains virtually zero particulate matter and significantly reduced noxious gases. By avoiding combustion (smoke), the user is able to achieve the same desired effects without the harmful side-effects of smoking.<br><div style="text-align:center; padding-top:20px;"><iframe width="560" height="315" src="//www.youtube.com/embed/LLAUt_94Ax8" frameborder="0" allowfullscreen style="box-shadow:0px 0px 11px rgba(1, 1, 1, 0.5); margin-top:5px;;"></iframe></div></p></div>
   </li>
   <li>
      <div class="section_title" ><span class="arrow" style="padding-right:20px;">&#x25BC;</span>What Types of Different Vaporizers Are There?</div>
      <div class="section_data" style="display:none;">
   ...
   <li>
      <div class="section_title"><span class="arrow" style="padding-right:20px;">&#x25BC;</span>How Do Vaporizers Work?</div>
      <div class="section_data" style="display:none;">
         ...
         <div style="text-align:center; margin-top:12px;"><div style="width:50%; text-align:center; display:inline-block;"><div style="font-weight:bold; text-align:left; ">Convection:</div><img src="images/learning_center/Convection-Image.jpg" style="margin-bottom:26px;" ></div><div style="width:50%; text-align:center; display:inline-block;"><div style="font-weight:bold; text-align:left; margin-bottom:14px; ">Conduction:</div><img src="images/learning_center/Conduction-Image.jpg"></div></div>
   ...
   <li>
      <div class="section_title"><span class="arrow" style="padding-right:20px;">&#x25BC;</span>Why Do People Vaporize?</div>
      <div class="section_data" style="display:none;">
         ...
         <p><b>Efficiency:</b> Vaporizing is also a great way to conserve your herbs. A very small amount of plant material goes a long way in a vaporizer, when compared to packing the same amount in a pipe or bong.</p>
   ...
   <li>
      <div class="section_title"><span class="arrow" style="padding-right:20px;">&#x25BC;</span>What is the Optimal Temperature for Vaporizing?</div>
      <div class="section_data" style="display:none;">
         ...
         <div style="text-align:center"><img src="images/learning_center/Vape-Gage.jpg"></div>
      </div>
   </li> 
   <li>
   	<div class="quiz-link-outer"><a href="http://www.vapornation.com/prodguide/learning-center/quiz?chapter=1" class="quiz-link">Click Here to Take the Chapter One Quiz</a></div>
